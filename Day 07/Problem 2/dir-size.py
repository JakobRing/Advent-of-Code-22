    ...
    for line in fp:
        ...
        if line_items[0] == "$":  # command
            ...
            if line_items[0] == "dir" and len(line_items) == 2:
                ...
                current_dir.add_file(File(line_items[1], int(line_items[0])))
            else:
                raise Exception("ls output is wrong")
    total_size = 70000000
    unused_space = total_size - root.get_size()
    print(root.get_smallest_size_with_at_least(30000000 - unused_space))
